...
type cases = [
  ...
  Assert<IsExact<PathValue<ComplexNestedRequired, "nested.array.0">, { bar: number }>>,
  // @ts-expect-error: 0.1 cannot be used as key
  Assert<IsExact<PathValue<ComplexNestedRequired, "nested.array.0.1">, { bar: number }>>,
  Assert<IsExact<PathValue<ComplexNestedRequired, "nested.array.10">, { bar: number }>>,
  Assert<IsExact<PathValue<ComplexNestedRequired, "nested.array.100">, { bar: number }>>,
  Assert<IsExact<PathValue<ComplexNestedRequired, "nested.array.1000">, { bar: number }>>,
  Assert<IsExact<PathValue<ComplexNestedRequired, "nested.array.10000">, { bar: number }>>,
  Assert<IsExact<PathValue<ComplexNestedRequired, "nested.array.100000">, { bar: number }>>,
  Assert<IsExact<PathValue<ComplexNestedRequired, `nested.array.0.bar`>, number>>,
