...
function testDeepPartial() {
  ...
  type cases = [
    ...
    Assert<IsExact<DeepPartial<Error>, Partial<Error>>>,
    Assert<IsExact<DeepPartial<ExtendedError>, Partial<Error> & { code?: string }>>,
    ...
    Assert<IsExact<DeepPartial<Set<readonly number[]>>, Set<readonly (number | undefined)[]>>>,
    Assert<IsExact<DeepPartial<ReadonlySet<string>>, ReadonlySet<string>>>,
    Assert<IsExact<DeepPartial<[]>, []>>,
    Assert<IsExact<DeepPartial<readonly []>, readonly []>>,
    ...
    Assert<IsExact<DeepPartial<ReadonlyArray<number>>, ReadonlyArray<number | undefined>>>,
