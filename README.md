...
- [`AsyncOrSyncType<Type>`](/lib/async-or-sync-type.ts) - Unwraps `AsyncOrSync` type
...
- [`isExact<Expected>()(actual)`](/lib/functions/is-exact.ts) - Matches runtime function, which validates that type of
