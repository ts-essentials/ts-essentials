 ...
 * 1. To generate the `TsVersion` type in [`lib/ts-version.ts`](../lib/ts-version.ts), which is then used in unit tests to handle version-specific output differences.
